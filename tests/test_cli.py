...
class TestListWaves:
    ...
    @responses.activate
    def test_list_waves_success(self, runner: CliRunner, mock_env_credentials: None) -> None:  # noqa: E501
        ...
        result = runner.invoke(
            list_waves,
            ["-M", "test_machine", "-P", "test_point", "-m", "test_mode"]
        )
        
        assert result.exit_code == 0
    
    @responses.activate
    def test_list_waves_auth_failure(self, runner: CliRunner, mock_env_credentials: None) -> None:  # noqa: E501
    ...
    def test_list_waves_missing_required_options(
...
class TestGetWave:
    ...
    def test_get_wave_both_date_and_timestamp(self, runner: CliRunner,
    mock_env_credentials: None
    ) -> None:
...
class TestCompareSpectra:
    ...
    def test_compare_spectra_success(
        ...
        result = runner.invoke(
            compare_spectra,
            [str(spectrum_file), str(wave_file)]
        )
