...
class TestHelperFunctions:
    ...
    def test_ensure_plots_directory(self, tmp_path: Path,
    ...
    def test_get_plot_filename(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
                               ) -> None:
...
class TestT8ApiClient:
    ...
    def test_check_ok_response_invalid_json(self, capsys: pytest.CaptureFixture
                                            ) -> None:
    ...
    def test_save_to_file_wave(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
                               ) -> None:
        ...
        # Check file exists
        expected_file = os.path.join("data", "waves", 
                                     "wave_machine1_point1_mode1_1234567890.json")
    ...
    def test_save_to_file_spectrum(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
        ...
        # Check file exists
        expected_file = os.path.join("data", "spectra", 
                                     "spectrum_machine2_point2_mode2_9876543210.json")
        assert os.path.exists(expected_file)
    ...
    def test_get_timestamp_and_formatted_wave_date(self) -> None:
        ...
        wave_data = {
            "_links": {
                "self": "http://example.com/waves/machine/point/mode/1234567890"
            }
        }
    ...
    def test_get_timestamp_and_formatted_wave_date_invalid(self) -> None:
        ...
        wave_data = {
            "_links": {
                "self": "http://example.com/waves/machine/point/mode/invalid"
            }
        }
...
class TestSpectrumComputation:
    ...
    def test_compute_spectrum_from_wave_data(
        ...
        waveform_data = [int(100 * np.sin(2 * np.pi * 0.1 * i)) 
                        for i in range(100)]
