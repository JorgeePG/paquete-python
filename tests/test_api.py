...
def test_get_wave_success()->None:
    ...
    assert client.get_wave("test_machine", "test_point", "test_proc_mode", 0) is not None  # noqa: E501
...
def test_get_spectrum_success()->None:
    ...
    assert client.get_spectrum("test_machine", "test_point", "test_proc_mode", 0) is not None  # noqa: E501
...
def test_get_spectrum_failure()->None:
    ...
    assert client.get_spectrum("test_machine", "test_point", "test_proc_mode", 0) is None  # noqa: E501
...
def test_get_spectrum_invalid_date()->None:
    ...
    assert client.get_spectrum("test_machine", "test_point", "test_proc_mode", -1) is None  # noqa: E501
